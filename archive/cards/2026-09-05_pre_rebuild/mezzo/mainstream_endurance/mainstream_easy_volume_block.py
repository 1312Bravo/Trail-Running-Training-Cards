...
mainstream_easy_volume_block = MezzoCard(
    id = 'mezzo_001',
    slug = 'mainstream-easy-volume-block',
    ...
    additional_information = 'This block is the simplest way to grow training capacity: run easily, repeat often, and avoid turning volume into hidden intensity. It fits well after a return phase or early in base development. For trail runners, easy volume can include gentle vertical gain and relaxed hiking, but technical descents and long steep climbs should not dominate the block.'
)
