...
mainstream_long_endurance_block = MezzoCard(
    id = 'mezzo_006',
    slug = 'mainstream-long-endurance-block',
    ...
    additional_information = 'Long endurance is about extending useful endurance, not simply collecting the biggest single run. The block should teach the athlete to pace, fuel, and recover from longer outings. For trail runners, duration and vertical gain may matter more than distance; hiking, poles, gear, and downhill fatigue can be trained as part of the long effort when relevant.'
)
