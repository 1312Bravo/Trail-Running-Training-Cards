...
mainstream_aerobic_power_block = MezzoCard(
    id = 'mezzo_005',
    ...
    additional_information = 'Aerobic power work is potent and should be used sparingly. It can improve performance when the athlete already has enough base to absorb intensity, but it becomes costly when layered on top of excessive volume or poor recovery. For trail runners, aerobic power can be developed on hills or smoother surfaces; the route should let the athlete produce high effort safely without chaotic footing or excessive downhill damage.'
)
