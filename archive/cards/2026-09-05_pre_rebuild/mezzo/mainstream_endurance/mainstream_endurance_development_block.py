...
mainstream_endurance_development_block = MezzoCard(
    id = 'mezzo_002',
    slug = 'mainstream-endurance-development-block',
    ...
    additional_information = 'This block develops endurance after basic consistency is already in place. The main stress is not high intensity, but accumulated aerobic work and a gradually more substantial long run. For trail runners, the long run may be measured by time and vertical gain rather than distance, with hiking used as a normal endurance skill when terrain demands it.'
)
