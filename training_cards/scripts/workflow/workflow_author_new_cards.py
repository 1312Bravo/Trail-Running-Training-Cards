    ...
    print(
        "\n".join(
            [
                ...
                "4. py -m training_cards.scripts.cache.validate_cache",
                "5. py -m training_cards.scripts.cache.build_bundle",
                ...
                "2. py -m training_cards.scripts.authoring.template_cloud_json_to_python_card --card-id <card_id>",
