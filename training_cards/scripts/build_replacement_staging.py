...
def build_cards() -> list:
    cards = [
        macro("macro_001", "Foundation And Consistency", ["common"], "Build repeatable running before adding specialised demands.", "Establish sustainable frequency, basic aerobic work, and confidence in the training process.", ["Use after interruption, at the start of a new cycle, or whenever consistency is the current limiter."], "The shared foundation prioritises athlete context, conservative progression, and enjoyable repeatable work before any named system-specific emphasis."),
        ...
        mezzo("mezzo_001", "Consistency And Durability Block", ["common"], "macro_001", "Accumulate repeatable running frequency with restrained load progression.", "Turn an inconsistent starting point into a stable week the runner can repeat.", "Mostly easy running, modest time-on-feet growth, and no need for a signature hard session.", "The common foundation makes this block athlete-centred and access-aware. Its success is predictable recovery and repeatability, not a rapid jump in volume."),
        ...
        micro("micro_001", "Consistency Week", ["common"], "mezzo_001", "A simple week that makes repeatable running the primary accomplishment.", "Protect frequency, easy effort, and confidence while the athlete establishes a reliable rhythm.", ["Several easy runs or run-walk outings.", "Optional short mobility or strength support.", "No required hard workout."], "The shared foundation makes the runner's actual life, terrain access, and response the basis for the week. The correct week is the one the athlete can repeat."),
        ...
        session("session_019", "Controlled Downhill Skills Run", ["common"], "micro_004", "A low-to-moderate-cost practice session for controlled downhill movement and terrain judgement.", "Develop skill, confidence, and gradual descent tolerance without treating downhill as free speed.", TRAIL_SPECIFIC_SESSION_FAMILY, [SessionPart("Warm-up", "15-20 minutes", "RPE 2-3", "Warm up on easy terrain before descending.", "Choose predictable, low-consequence downhill terrain."), SessionPart("Skill descents", "6-12 x 30-90 seconds", "RPE 4-6", "Descend under control with quiet steps, stable posture, and enough recovery to retain coordination.", "Walk or jog back up; reduce technicality before increasing speed."), SessionPart("Easy finish", "10-15 minutes", "RPE 1-2", "Finish on easy terrain and assess delayed muscle soreness.", "Do not add long descents after the main skill practice.")], ["Technical and coordination demand", "Eccentric cost tracked separately from heart rate", "Gradual exposure"], "The shared foundation makes the terrain and recovery cost explicit. This card remains common because it teaches a broadly useful trail skill without adopting a named system's distinctive sequencing model.", ["Downhill coordination", "Confidence", "Controlled eccentric tolerance"], ["Do not progress speed and technicality together.", "Do not use when soreness or fear prevents controlled movement." ]),
