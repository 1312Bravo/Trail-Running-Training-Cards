...
base_development = MacroCard(
    ...
    additional_information = 'Base development gives the athlete more room to train before intensity becomes the limiting factor. Most work should remain easy to steady, with progression coming from consistency, frequency, duration, and carefully managed long runs. For trail runners, this phase can include moderate vertical gain, hiking efficiency, and varied surfaces, but the goal is still sustainable aerobic development rather than hard mountain-specific stress. A good base phase should leave the athlete more durable, not simply more tired.'
)
