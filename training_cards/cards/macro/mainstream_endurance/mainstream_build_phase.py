...
mainstream_build_phase = MacroCard(
    id = 'macro_003',
    slug = 'mainstream-build-phase',
    title = 'Build Phase',
    ...
    additional_information = 'The build phase introduces more demanding work once the athlete can already absorb regular training. The exact emphasis can vary: threshold control, aerobic power, strength endurance, or long-endurance development. The key is to add stress deliberately while keeping enough low-intensity running to maintain durability and recovery. For trail runners, this is where climbing strength, controlled downhill exposure, and terrain-specific fatigue resistance can become more prominent without overwhelming the plan.'
)
