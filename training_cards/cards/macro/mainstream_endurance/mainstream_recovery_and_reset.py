...
mainstream_recovery_and_reset = MacroCard(
    id = 'macro_006',
    slug = 'mainstream-recovery-and-reset',
    ...
    additional_information = 'Recovery and reset protects long-term progress by giving the athlete space to absorb work rather than immediately chasing the next block. It can follow a race, a demanding training phase, or a period of high life stress. Running can remain present, but it should feel optional, easy, and restorative until normal motivation and recovery return. For trail runners, this phase should be especially cautious after races with long descents, technical terrain, or high muscle damage.'
)
