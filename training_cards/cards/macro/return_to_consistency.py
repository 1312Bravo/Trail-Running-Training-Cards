...
return_to_consistency = MacroCard(
    ...
    additional_information = 'This macro is for the period when the main goal is not fitness expression, but rebuilding the ability to train consistently. The emphasis is easy aerobic work, predictable frequency, gentle progression, and enough recovery that the athlete finishes most sessions feeling controlled. For trail runners, the terrain should be simple at first: modest climbing, limited hard descending, and hiking only as a low-stress aerobic tool. The phase is successful when training feels repeatable across weeks and the athlete can tolerate normal easy running without accumulating unusual soreness or fatigue.'
)
