...
race_specific_preparation = MacroCard(
    ...
    additional_information = 'Race-specific preparation is where training starts to look more like the goal without copying the race every week. The athlete practices the demands that matter most: pacing, long efforts, fueling, surface, elevation pattern, heat, technicality, or sustained intensity. For trail and mountain runners, this may mean vertical gain, hiking transitions, downhill durability, uneven pacing, and gear or nutrition rehearsal. The phase should sharpen readiness while avoiding the trap of doing race simulations so often that the athlete arrives tired.'
)
