...
peak_and_taper = MacroCard(
    ...
    additional_information = 'Peak and taper is not a time to build major new fitness. The work shifts toward maintaining rhythm, preserving intensity touches, reducing total load, and arriving mentally calm. For trail runners, the final weeks should keep enough terrain familiarity to feel coordinated while avoiding excessive downhill damage, technical risk, or long fatigue-heavy outings. The best taper is specific enough to maintain confidence and light enough to reveal fitness.'
)
