...
mainstream_fueling_practice_block = MezzoCard(
    id = 'mezzo_008',
    slug = 'mainstream-fueling-practice-block',
    ...
    additional_information = 'Fueling practice is not only for very long races. Any runner whose goal involves sustained effort can benefit from learning what intake is tolerated at the relevant intensity and duration. For trail runners, fueling may need to work during climbs, descents, hiking, heat, cold, altitude, or technical terrain when eating and drinking are less convenient.'
)
