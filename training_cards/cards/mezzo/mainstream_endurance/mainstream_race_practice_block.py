...
mainstream_race_practice_block = MezzoCard(
    id = 'mezzo_007',
    slug = 'mainstream-race-practice-block',
    ...
    additional_information = 'Race practice turns fitness into execution. The block should include enough specificity to reveal problems before race day, but not so much that every week becomes a full simulation. For trail runners, this often means practicing effort-based pacing, climbs, descents, hiking transitions, gear choices, fueling under movement, and technical confidence.'
)
