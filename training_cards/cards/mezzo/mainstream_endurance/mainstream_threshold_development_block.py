...
mainstream_threshold_development_block = MezzoCard(
    id = 'mezzo_004',
    slug = 'mainstream-threshold-development-block',
    ...
    additional_information = 'Threshold work is useful because many running performances depend on sustaining a strong but controlled effort. The block should emphasize control: efforts are hard enough to create adaptation, but not so hard that they become repeated races. For trail runners, threshold can be done by effort on climbs, rolling terrain, or smoother surfaces depending on the goal; pace alone is often unreliable on variable terrain.'
)
