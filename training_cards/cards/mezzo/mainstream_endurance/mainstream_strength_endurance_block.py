...
mainstream_strength_endurance_block = MezzoCard(
    id = 'mezzo_003',
    ...
    additional_information = 'This block adds controlled muscular demand through hills, sustained efforts, strength support, or terrain that requires forceful running. It should feel strong and controlled, not like repeated maximal efforts. For trail runners, this is one of the most transferable blocks because climbs, descents, uneven footing, and hiking transitions often expose strength-endurance limits.'
)
